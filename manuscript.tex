...
\begin{figure}
\includegraphics[width=1\linewidth]{figures/TontoBasin} \caption{Location of Tonto Basin in the state of Arizona, United States, along with archaeological sites discussed in this paper grouped by site cluster.}\label{fig:TontoBasinMap}
\end{figure}
...
\addcontentsline{toc}{subsection}{Projectile Points of the Southwest}
...
\addcontentsline{toc}{subsection}{Justice Projectile Points}
...
\addcontentsline{toc}{subsubsection}{Elliptical Fourier Analysis}
...
\addcontentsline{toc}{subsubsection}{Semilandmarks}
...
\addcontentsline{toc}{subsubsection}{Landmarks}
